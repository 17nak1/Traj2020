...
let temp, file;
file = fs.readFileSync(rootDir+'/exampleJS/data/London_covar.csv').toString();
...
file = fs.readFileSync(rootDir+'/exampleJS/data/ParamSet_DeterministicSEIR_run28.csv').toString()
lines = file.split(/\r\n|\n/);
